...
CHUNK_SIZE = 1800          # text chunk sent to model
...
def call_openrouter(chunk):
    prompt = (
        ...
        "Create AT MOST 5 MEDIUM-difficulty MCQs.\n\n"
        "Rules:\n"
        "- Exactly 4 options\n"
...
async def handle_pdf(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ---------- BUNDLING LOGIC (MIN 20 PER QUIZ) ---------- #
...
def main():
    ...
    logging.info("MCQ Bot running (SAVE MODE, min 20 per quiz)")
    app.run_polling()
